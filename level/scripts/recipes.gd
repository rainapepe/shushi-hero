...
#class RecipeIngredient:
	...
	#
	#func _init(payload: Dictionary):
		#self.amount = payload["amount"]
		#self.item_texture = payload["item_texture"]
#
#class Recipe:
	#var name: String
	#var item_texture: String
	...
	#func _init(payload: Dictionary):
		...
		#for ingredient_name in payload["ingredients"]:
			#var ingredient = payload["ingredients"][ingredient_name]
			#ingredient["name"] = ingredient_name
			#self.ingredients.push_back(RecipeIngredient.new(ingredient))
	#
	#func debug() -> void:
		#print("Recipe: " + self.name)
		#print("---- Price: " + str(self.price))
		#print("---- Texture: " + self.item_texture)
		#print("---- Ingredients: " + str(self.ingredients.size()))
		#for ingredient in ingredients:
			#print("-------- Ingredient: " + ingredient.name)
			#print("------------ Amount: " + str(ingredient.amount))
			#print("------------ Texture: " + ingredient.item_texture)
#
#static func get_recipe(name: String) -> Recipe:
	#if recipes_dict.has(name):
		#var payload: Dictionary = recipes_dict[name].duplicate(true)
		#payload["name"] = name
#
		#return Recipe.new(payload)
	#return null

const recipes_dict: Dictionary = {
	"chukaman": {
